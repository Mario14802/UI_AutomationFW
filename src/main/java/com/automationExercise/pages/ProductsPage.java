...
public class ProductsPage {
    ...
    private final By addedSuccefullylabel = By.xpath("//div[@class='modal-body']/p[contains(.,'Your product has been added to cart.')]");
    String ProductUrl = PropertyReader.getProperty("BASE_URL") + "/products";
    ...
    public ProductsPage navigateToProductPage() {
        driver.browser().navigateTo(ProductUrl);
        return this;
    }
    ...
    public ProductsPage validateItemAddedLabel(String expectedText) {
        String actualTxt = driver.element().getText(addedSuccefullylabel);
